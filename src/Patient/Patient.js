...
const [editFormData, setEditFormData] = useState({
  ...
  const HandleSearchName = (e) =>{
   ...
   const handleSave = () =>{
    ...
    fetch("http://localhost:5001/insertNewPatient?id=" +newPatient.id +"&Name="+newPatient.Name + "&Email="+ newPatient.Email+"&Phone"+newPatient.phone)
      ...
      {modal &&(   
        <Edit user={editFormData}/>    
          ...
          {addpatient &&(
            ...
            <input type='text' placeholder='Name' className='form-control'style={{width:"400px"}} id='inp_name' />
